...
|Lecture 2 |Data munging|[_RPubs_ link](//rpubs.com/kamermanpr/PHSL4005-biostats-lecture-2)  | [Standalone slides](//dl.dropboxusercontent.com/u/11805474/PHSL4005-biostats/lectures/lecture_2.html?dl=1)|
...
_If you are using the computer lab computers, the computers may not have the software installed, or it may have old versions installed. If so, please install/update the software. In the case of computer laboratory computers, which have multiple users, please note the following:_
...
_Rather set the configurations only for the directory you want to initialize with git:_ 
