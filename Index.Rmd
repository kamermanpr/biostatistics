...
|Lecture       |Content                                |Slides (RPubs)                                                           |Download slides        |
|:--------------|:--------------------------------------|:------------------------------------------------------------------------|:---------------------|
|Introduction   |Course overview                        |[_RPubs_ link](//rpubs.com/kamermanpr/PHSL4005-biostats-introduction)|[Standalone slides](//dl.dropboxusercontent.com/u/11805474/PHSL4005-biostats/lectures/introduction.html?dl=1)|
|Lecture 1 |Basic concepts and tools for reproducible research|[_RPubs_ link](//rpubs.com/kamermanpr/PHSL4005-biostats-lecture-1)  | [Standalone slides](//dl.dropboxusercontent.com/u/11805474/PHSL4005-biostats/lectures/lecture_1.html?dl=1)|
|Lecture 2 |Basic concepts and tools for reproducible research|[_RPubs_ link](//rpubs.com/kamermanpr/PHSL4005-biostats-lecture-2)  | [Standalone slides](//dl.dropboxusercontent.com/u/11805474/PHSL4005-biostats/lectures/lecture_2.html?dl=1)|

_**[More to be added as course progresses]**_

## Assignments

The assignments are your chance to get hands-on experience using the information you learned in the lectures. The assignments will completed with the instructor in the computer laboratory immediately after the relevant lecture has been finished. You may work alone or in groups.

|Tutorial                   |files                                |
|:--------------------------|:------------------------------------|
|Assignment 1 (lecture 1)   |[[download]](//dl.dropboxusercontent.com/u/11805474/PHSL4005-biostats/assignments/assignment_1.md?dl=1) the file, and follow the instructions |
...
_If you are using the computer lab computers, the computers may not have the software installed, or it may have old versions installed. If so, please install/update the software. In the case of computer laboratory computers, which have multiple users, please note the following:

_When using git, do not use:_
...
_Rather set the configurations for the directory you want to initialize with git only:_ 
