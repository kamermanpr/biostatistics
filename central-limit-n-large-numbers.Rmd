---
title:          'Central Limit Theorem and the Law of Large Numbers: The gganimate package in action'
...
This leads us to the _Law of Large Numbers_. At a simplistic level, the Central Limit Theorem tells us about the shape of the sampling distribution, while the Law of Large Numbers tells us where the centre of the distribution lies. From the Law of Large Numbers we get that cumulatively, the result from a large number of trials tends towards the true value in the population. That is, the probability of an unusual outcome becomes smaller as the number of trials increases This convergence in probability is also called the _Weak Law of Large Numbers_. 
...
#### GitHub
You can grab the full _R script_ from  [GitHub](https://github.com/kamermanpr/miscellaneous/central-limit-n-large-numbers).
<br><br>
