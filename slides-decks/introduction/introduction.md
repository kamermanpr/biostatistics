...
<div style="position:fixed;bottom:10%">
    ...
    <p style="font-style:italic;font-size:80%;margin-top:1%;margin-bottom:1%;">
        ...
        <a href="//github.com/kamermanpr/biostatistics.git" target="_blank">GitHub</a>)<br>
            Based on slides from Jeff Leek:&nbsp
                <a href="http://jtleek.com/genstats_site" target="_blank">Statistics for Genomic Data Science</a>
        </p>
...
"Statistics is study design"

Example 1
=========
title: none

<img class="center" src="./resources/example-1.jpg" width="850" height="600">
...
<img class="center" src="./resources/example-2.jpg" width="850" height="600">
...
<img class="center" src="./resources/example-3.png" width="850" height="600">
...
5. Hypothesis / Significance testing
